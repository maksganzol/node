...
function GET(count, resp){
    ...
    var request = require('request');//ИСПРАВИТЬ НА  10 000!!!!!!!!
    request('https://www.random.org/integers/?num=2&min=0&max=1&col=1&base=10&format=plain&rnd=new', function (error, response, body) {
        if(count<=10){
            count++;
